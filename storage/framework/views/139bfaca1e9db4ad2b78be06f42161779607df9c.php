...
<div id="page-wrapper">
     ...
     <div class="col-lg-12">
      <div class="panel panel-default">
       <div class="panel-heading">
          <a href="<?php echo e(URl('/payment-update')); ?>"><button type="button" class="btn btn-success">Back </button></a>
  ...
  <div class="section">
    <?php $__currentLoopData = $receiptPayment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <div>
      <div class="section2">
