     ...
     <div class="col-lg-12">
      <div class="panel panel-default">
       <div class="panel-heading">
          <a href="<?php echo e(URl('amc')); ?>"><button type="button" class="btn btn-success">Back </button></a>
  ...
  <div class="section">
     ...
     <div>
      <div class="section2">
        ...
        <?php $__currentLoopData = $amcReceipt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="section4">
