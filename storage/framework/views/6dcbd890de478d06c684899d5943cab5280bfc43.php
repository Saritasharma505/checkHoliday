     ...
     <div class="col-lg-12">
      <div class="panel panel-default">
       <div class="panel-heading">
          <a href="<?php echo e(URl('configuration')); ?>"><button type="button" class="btn btn-success">Back </button></a>
       </div>
      <!-- /.panel-heading -->
			 <div class="panel-body">
			 	...
			 	<div class="container">
				  ...
				  <form action="<?php echo e(url('/addconfiguration/save')); ?>" method="post">
				  	<?php echo csrf_field(); ?>
				    <div class="col-lg-5">
