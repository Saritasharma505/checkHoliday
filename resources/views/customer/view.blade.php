                           ...
                           ?>
                            <tr>
                               <td><?php echo $i++;?></td>
                                ...
                                <td colspan="2"><a class="btn btn-danger" href="{{url('admin/customer-view-message-show-single')}}/{{$value->memberShipid}}/{{$value->id}}">Complain</a>
                                </td>

                                <?php } else if($value->status_red==1){ ?>
                                <td colspan="2"><a href="{{url('admin/customer-view-message-show-single')}}/<?php echo $value->memberShipid;?>/<?php echo $value->id;?>" class="btn btn-info">Continue</a></td>
                                <?php } else{ ?>
                                <td colspan="2">
